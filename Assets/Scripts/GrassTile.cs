...
{
    /// <summary>
    /// Grass Tiles are meant to update their sprites over time to mimic growth and being cut down by the player
    /// </summary>
    [System.Serializable]
    public class GrassTile : Tile
    {
        /// <summary>
        /// The Sprites used for defining the different stages of growth.
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// This method is called when the tile is refreshed. The GrassTile will refresh all neighboring tiles to update their rendering data if they are the same tile.
        /// </summary>
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
        {
            ...
            // Debug.Log("GetTileData: " + tileData.sprite);
            // tileData.sprite = m_Sprites[1];
        }

        /*public void PlantSeed()
        {
            // Start timer to change sprite
        }*/
        ...
        /// The mask will determine the according Sprite and transform to be rendered at the given position. The Sprite and Transform is then filled 
        /// into TileData for the Tilemap to use. The Flags lock the color and transform to the data provided by the tile. The ColliderType is set to 
        /// the shape of the Sprite used.
        /// </summary>
        private void UpdateTile(Vector3Int position, ITilemap tilemap, ref TileData tileData)
        {
            ...
            int index = m_currentIndex; // GetIndex((byte) mask);
    ...
    public class GrassTileEditor : Editor
    {
        ...
        /// <summary>
        /// Draws an Inspector for the GrassTile.
        /// </summary>
        ...
        /// <summary>
        /// The following is a helper that adds a menu item to create a GrassTile Asset in the project.
        /// </summary>
